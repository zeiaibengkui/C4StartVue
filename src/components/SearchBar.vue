...
<template>
  ...
  <form @submit="submit" id="searchBar" class="input-group shadow">
    ...
    <div class="dropdown-menu" aria-labelledby="searchEigine" style="--bs-border-radius: 0.375rem">
    ...
    <input class="form-control" id="searchText" type="text" v-model="text" placeholder="搜索..." />
